...
<body id="app" class="font-hind pt-36">
  ...
  <article class="mx-60 my-20">
    ...
    <form method="POST" enctype="multipart/form-data" action="{{ route('event.storeEvent') }}">
      ...
      <div class="my-6 relative">
        <input required type="text" name="name" id="inputNamaKepanitiaan"
      ...
      <div class="my-6 relative">
        <input required type="text" name="group_chat_link" id="inputGroupChatLink"
          class="block px-2.5 pb-2.5 pt-4 w-full text-sm rounded-lg border-2 border-gray-500 hover:border-black appearance-none dark:border-gray-500 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
          placeholder=" " />
      ...
      <div class="mb-6 relative">
        <textarea id="inputDeskripsi" rows="10" name="description"
      ...
      <div class="flex items-center gap-4">
        ...
        <div class="flex items-center border-2 border-gray-300 rounded-lg px-4 py-2">
          ...
          <input required type="text" name="start_date" id="startDate"
            class="date-placeholder border-0 max-w-[9em] focus:ring-0" placeholder="Awal Kegiatan"
        ...
        <div class="flex items-center border-2 border-gray-300 rounded-lg px-4 py-2">
          ...
          <input required type="text" name="end_date" id="endDate"
            class="date-placeholder border-0 max-w-[9em] focus:ring-0" placeholder="Akhir Kegiatan"
            onfocus="(this.type='date'); this.classList.remove('date-placeholder');"
            onblur="if(!this.value){ this.type='text'; this.classList.add('date-placeholder'); }">
        </div>
      </div>
