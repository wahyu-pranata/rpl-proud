...
<button onclick="goBack()" class="p-4 bg-gray-200 rounded-full hover:bg-gray-300">
    ...
    <article class="mx-60 my-20">
        ...
        <form>
            ...
            <div class="my-6 relative">
                    <input required name="event_name" type="text" id="nama_kepanitiaan" class="block px-2.5 pb-2.5 pt-4 w-full text-sm rounded-lg border-2 border-gray-500 hover:border-black appearance-none dark:border-gray-500 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
    ...
    <div class="flex items-center gap-4">
        ...
        <input required name="start_date" type="text" id="startDate" class="date-placeholder border-0 max-w-[9em] focus:ring-0" placeholder="Awal Kegiatan" 
        ...
        <input required name="end_date" type="text" id="endDate" class="date-placeholder border-0 max-w-[9em] focus:ring-0" placeholder="Akhir Kegiatan" 
        onfocus="(this.type='date'); this.classList.remove('date-placeholder');" 
        onblur="if(!this.value){ this.type='text'; this.classList.add('date-placeholder'); }">
        </div>
    </div>
...
<!--Desain Poster-->
<x-upload-file id='(id)' name='event_poster'>Desain Poster</x-upload-file>

<!--File Jobdesk-->
<x-upload-file id='(id)' name='event_jobdesk'>File Jobdesk</x-upload-file>
...
<!-- Tombol Unggah -->
    ...
    <input type="submit" name="add_proker_submit" value="Unggah" class="bg-blue-900 text-white font-semibold mb-16 mt-8 py-2 px-6 rounded-lg cursor-pointer hover:bg-blue-700">
    </article>
</body>
</html>