<div id="{{ $tableID }}"class="relative mt-6 h-full hidden">
                        ...
                        <div class="flex pr-2 justify-between">
                            ...
                            <div class="flex space-x-6">
                                <div class="text-center">
                                    <div>Tolak</div>
                                    <button class="flex items-center justify-center w-12 h-12 bg-red-500 text-white hover:bg-white hover:text-red-500 hover:border-2 hover:border-red-500 transition rounded-lg mt-2">
                                ...
                                <div class="text-center">
                                    <div>Terima</div>
                                    <button class="flex items-center justify-center w-12 h-12 bg-blue-500 text-white hover:bg-white hover:text-blue-500 hover:border-2 hover:border-blue-500 transition rounded-lg mt-2">
