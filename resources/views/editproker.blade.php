  ...
  <article class="mx-60 my-20">
    ...
    <form>
      ...
      <div class="my-6 relative">
        <input required type="text" id="nama_kepanitiaan"
      ...
      <div class="mb-6 relative">
        <textarea id="deskripsi_kegiatan" rows="10"
    ...
    <div class="flex items-center mb-4">
      ...
      <input required type="text" id="sieInput" placeholder="Tambah Sie yang dibutuhkan"
    ...
    <div class="flex items-center gap-4">
      ...
      <div class="flex items-center border-2 border-gray-300 rounded-lg px-4 py-2">
        ...
        <input required type="text" id="startDate" class="date-placeholder border-0 max-w-[9em] focus:ring-0"
          placeholder="Awal Kegiatan" onfocus="(this.type='date'); this.classList.remove('date-placeholder');"
      ...
      <div class="flex items-center border-2 border-gray-300 rounded-lg px-4 py-2">
        ...
        <input required type="text" id="endDate" class="date-placeholder border-0 max-w-[9em] focus:ring-0"
          placeholder="Akhir Kegiatan" onfocus="(this.type='date'); this.classList.remove('date-placeholder');"
          onblur="if(!this.value){ this.type='text'; this.classList.add('date-placeholder'); }">
      </div>
    </div>
    ...
    <div class="max-w-3xl space-y-6 my-6">
      ...
      <button id="add-agenda" class="flex items-center space-x-2 text-black hover:text-blue-700">
        <div
          class="flex items-center justify-center w-10 h-10 text-blue-600 bg-white border-2 rounded-lg border-gray-600 hover:bg-blue-100">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="black"
            class="w-7 h-7">
      ...
      <div id="agenda-list" class="space-y-4">
        ...
        <div class="bg-blue-100 p-4 rounded-lg flex items-center space-x-4" data-agenda>
          <!-- Nama Agenda -->
          <input required type="text" name="agenda_name[]" placeholder="Nama Agenda"
            class="flex-1 border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" />

          <!-- Waktu Agenda -->
          <div class="relative flex-1">
            <input required type="text" id="endDate" name="agenda_date[]"
              ...
              placeholder="Waktu Agenda" onfocus="(this.type='date'); this.classList.remove('date-placeholder');"
              onblur="if(!this.value){ this.type='text'; this.classList.add('date-placeholder'); }">
          </div>
    ...
    <!--Desain Poster-->
    <x-upload-file name="desain_poster" id='(id)'>Desain Poster</x-upload-file>

    <!--File Jobdesk-->
    <x-upload-file name="file_jobdesk" id='(id)'>File Jobdesk</x-upload-file>
    ...
    <div class="flex items-center justify-center mt-8">
      ...
      <input type="submit" value="Simpan"
        class="bg-blue-900 text-white font-semibold mx-5 py-2 px-6 rounded-lg cursor-pointer hover:bg-blue-700">
      <!-- Tombol Hapus -->
      <button class="border border-red-500 text-red-500 mx-5 px-6 py-2 rounded hover:bg-red-500 hover:text-white"
        onclick="refreshPage()">
        Hapus
      </button>
    </div>
