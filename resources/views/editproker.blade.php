...
<button onclick="goBack()" class="p-4 bg-gray-200 rounded-full hover:bg-gray-300">
    ...
    <article class="mx-60 my-20">
        ...
        <form>
            ...
            <div class="my-6 relative">
                    <input required  name="edit_event_name" type="text" id="nama_kepanitiaan" class="block px-2.5 pb-2.5 pt-4 w-full text-sm rounded-lg border-2 border-gray-500 hover:border-black appearance-none dark:border-gray-500 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
    ...
    <div id="input-container">
        ...
        class="sie-input ml-4 px-4 py-2 w-full border rounded focus:outline-none"
        />
    </div>
    </div>

    <!-- Daftar Chip Sie -->
    <div id="sie-list" class="flex flex-wrap gap-2 mb-4">
    <!-- Chip akan ditampilkan di sini -->
    </div>
</div>
    ...
    <div class="flex items-center gap-4">
        ...
        <input required name="edit_start_date" type="text" id="startDate" class="date-placeholder border-0 max-w-[9em] focus:ring-0" placeholder="Awal Kegiatan" 
        ...
        <input required name="edit_end_date" type="text" id="endDate" class="date-placeholder border-0 max-w-[9em] focus:ring-0" placeholder="Akhir Kegiatan" 
        onfocus="(this.type='date'); this.classList.remove('date-placeholder');" 
        onblur="if(!this.value){ this.type='text'; this.classList.add('date-placeholder'); }">
        </div>
    </div>
    ...
    <div 
        ...
        required
        type="text" 
        name="edit_agenda_name[]" 
        placeholder="Nama Agenda"
        class="flex-1 border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" />

        <!-- Waktu Agenda -->
        <div class="relative flex-1">
        <input required type="text" id="endDate" name="edit_agenda_date[]" class="date-placeholder w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Waktu Agenda" 
        onfocus="(this.type='date'); this.classList.remove('date-placeholder');" 
        onblur="if(!this.value){ this.type='text'; this.classList.add('date-placeholder'); }">
        </div>
...
<!--Desain Poster-->
<x-upload-file id='(id)' name='edit_event_poster'>Desain Poster</x-upload-file>

<!--File Jobdesk-->
<x-upload-file id='(id)' name='edit_event_jobdesk'>File Jobdesk</x-upload-file>
...
<!-- Tombol Unggah -->
    <input type="submit" name="edit_proker_submit" value="Simpan" class="bg-blue-900 text-white font-semibold mx-5 py-2 px-6 rounded-lg cursor-pointer hover:bg-blue-700">
<!-- Tombol Hapus -->
    <button 
