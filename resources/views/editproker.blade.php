...
<button onclick="goBack()" class="p-4 bg-gray-200 rounded-full hover:bg-gray-300">
    ...
    <article class="mx-60 my-20">
        ...
        <form>
            ...
            <div class="my-6 relative">
                    <input required type="text" id="nama_kepanitiaan" class="block px-2.5 pb-2.5 pt-4 w-full text-sm rounded-lg border-2 border-gray-500 hover:border-black appearance-none dark:border-gray-500 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
    ...
    <div class="flex items-center gap-4">
        ...
        <input required type="text" id="startDate" class="date-placeholder border-0 max-w-[9em] focus:ring-0" placeholder="Awal Kegiatan" 
        ...
        <input required type="text" id="endDate" class="date-placeholder border-0 max-w-[9em] focus:ring-0" placeholder="Akhir Kegiatan" 
        onfocus="(this.type='date'); this.classList.remove('date-placeholder');" 
        onblur="if(!this.value){ this.type='text'; this.classList.add('date-placeholder'); }">
        </div>
    </div>
...
<!--Desain Poster-->
<x-upload-file id='(id)'>Desain Poster</x-upload-file>

<!--File Jobdesk-->
<x-upload-file id='(id)'>File Jobdesk</x-upload-file>
