...
<button onclick="goBack()" class="p-4 bg-gray-200 rounded-full hover:bg-gray-300">
    ...
    <article class="mx-60 my-20">
        ...
        <div class="my-6 relative">
            <input required name="edit_recruitment_link" type="text" id="link_kepanitiaan" class="block px-2.5 pb-2.5 pt-4 w-full text-sm rounded-lg border-2 border-gray-500 hover:border-black appearance-none dark:border-gray-500 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
    ...
    <div class="flex items-center gap-4 my-6">
        ...
        <input required name="edit_recruitment_start_date" type="text" id="startDate" class="date-placeholder border-0 max-w-[9em] focus:ring-0" placeholder="Awal Rekrutmen" 
        ...
        <input required name="edit_recruitment_end_date" type="text" id="endDate" class="date-placeholder border-0 max-w-[9em] focus:ring-0" placeholder="Akhir Rekrutmen" 
        onfocus="(this.type='date'); this.classList.remove('date-placeholder');" 
        onblur="if(!this.value){ this.type='text'; this.classList.add('date-placeholder'); }">
        </div>
    </div>
...
<div class="relative">
    ...
    <!-- Dropdown Menu -->
    <select required id="dropdownMenu" name="edit_option[]" class="px-4 py-2 border rounded focus:outline-none">
        <option>Ya</option>
        <option>Tidak</option>
...
<!-- Tombol Unggah -->
        <input type="submit" name="edit_recruitment_submit" value="Simpan" class="bg-blue-900 text-white font-semibold mx-5 py-2 px-6 rounded-lg cursor-pointer hover:bg-blue-700">
<!-- Tombol Hapus -->
        <button 
